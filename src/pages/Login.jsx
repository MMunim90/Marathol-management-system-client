...
const Login = () => {
  ...
  return (
    <div className="hero-content flex-col lg:flex-row w-full mx-auto">
      <Helmet>
        <title>Login | Runfinity</title>
      </Helmet>
      <div className="w-full lg:max-w-md p-8 space-y-3 my-10 mx-auto md:w-6/12 lg:w-full">
        <FadeIn>
          ...
          <div className="flex justify-center space-x-4 my-6">
            <button
              ...
              className="btn btn-outline text-xl w-full py-6"
            >
          ...
          <p className="text-md text-center sm:px-6">
            ...
            <Link to="/register" className="ml-2 underline text-blue-500">
              Register
            </Link>
          </p>
      ...
      <div className="text-center lg:text-left w-auto hidden lg:block">
